...
static void reset_event_cb(lv_event_t *e) { esp_restart(); }
...
static void Settings_create(void) {
  ...
  /* Top settings panel */
  lv_obj_t *panel = lv_obj_create(settings_scr);
  ...
  /* Buttons aligned like on main page */
  ...
  static lv_coord_t btn_cols[] = {LV_GRID_CONTENT, LV_GRID_CONTENT,
                                  LV_GRID_TEMPLATE_LAST};
  ...
  lv_obj_set_grid_cell(back_btn, LV_GRID_ALIGN_CENTER, 0, 1,
  ...
  lv_obj_set_grid_cell(reset_btn, LV_GRID_ALIGN_CENTER, 1, 1,
                       LV_GRID_ALIGN_CENTER, 0, 1);
...
static void Status_create(lv_obj_t *parent) {
  ...
  static lv_coord_t row_cols[] = {LV_GRID_FR(1), LV_GRID_FR(1),
                                  LV_GRID_TEMPLATE_LAST};
  static lv_coord_t row_rows[] = {LV_GRID_CONTENT, LV_GRID_TEMPLATE_LAST};
  static lv_coord_t field_cols[] = {LV_GRID_CONTENT, LV_GRID_FR(1),
...
#define MAKE_FIELD(ROW, COL, ICON_TXT, OUT_ICON, OUT_VAL, OUT_UNITS,           \
                   INIT_VAL_TXT, UNITS_TXT)                                    \
  do {                                                                         \
    ...
    lv_obj_set_grid_cell(OUT_ICON, LV_GRID_ALIGN_START, 0, 1,                  \
                         LV_GRID_ALIGN_CENTER, 0, 1);                          \
    /* value (right) */                                                        \
    ...
    lv_obj_set_grid_cell(OUT_VAL, LV_GRID_ALIGN_END, 1, 1,                     \
                         LV_GRID_ALIGN_CENTER, 0, 1);                          \
    ...
    lv_obj_set_grid_cell(OUT_UNITS, LV_GRID_ALIGN_START, 2, 1,                 \
                         LV_GRID_ALIGN_CENTER, 0, 1);                          \
  } while (0)
  ...
  MAKE_FIELD(row_top, 0, MDI_THERMOMETER, temp_icon, temp_label,
             temp_units_label, "0.0", "°C");
...
void example1_increase_lvgl_tick(lv_timer_t *t) {
  ...
  enum { CONN_NONE, CONN_MQTT, CONN_ESPNOW };
  int conn = CONN_NONE;
  ...
  if (conn_label && conn != last_conn_type) {
    ...
    case CONN_ESPNOW:
      ...
      lv_obj_set_style_text_color(conn_label, lv_palette_main(LV_PALETTE_CYAN),
                                  0);
      break;
    default:
      lv_label_set_text(conn_label, "");
